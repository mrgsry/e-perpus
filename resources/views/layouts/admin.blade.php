                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.mahasiswa.index') }}"
                                ...
                                <span class="badge-sidebar"
                                    style="position:absolute; top:50%; right:15px; transform:translateY(-50%); font-size:9px; padding:2px 6px; border-radius:10px; background-color:#e74c3c; color:#fff; font-weight:bold; line-height:1;">
