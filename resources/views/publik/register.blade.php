...
<div class="register-page">
    <div class="register-box">
        ...
        <div class="register-card">
            ...
            <form id="registerForm" method="POST" action="{{ route('publik.register.store') }}" novalidate>
                ...
                <div class="field-wrap">
                    <input class="field-input" type="text" id="nama" name="nama" placeholder="Masukkan nama lengkap"
                ...
                <div class="field-wrap">
                    <input class="field-input" type="text" id="nim" name="nim" placeholder="Masukkan NIM" required
                ...
                <div class="field-wrap">
                    <select class="field-input" id="jurusan" name="jurusan" required>
                ...
                <div class="field-wrap">
                    <input class="field-input" type="tel" id="no_telepon" name="no_telepon"
                        placeholder="Contoh: 08123456789" autocomplete="tel" spellcheck="false">
                    <svg class="field-ico" viewBox="0 0 24 24">
                ...
                <div class="field-wrap">
                    <input class="field-input" type="email" id="email" name="email"
                        placeholder="contoh: nama@example.com" required autocomplete="email" spellcheck="false">
                    <svg class="field-ico" viewBox="0 0 24 24">
                        <path
        ...
        <p class="register-footer">Sudah terdaftar? <a href="{{ route('publik.cek-status') }}">Cek Status Peminjaman</a>
        </p>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body-custom">
                <div class="success-message">
                    ...
                    <p class="success-text">Data pendaftaran Anda telah kami terima dan sedang dalam proses verifikasi.
                    </p>
                </div>
                ...
                <div class="info-alert">
                    ...
                    <div class="info-alert-text">
                        <p>Pendaftaran Anda sedang menunggu persetujuan admin. Kami akan menghubungi Anda melalui nomor
                            telepon yang terdaftar jika ada informasi lebih lanjut.</p>
                    </div>
                </div>
            </div>
