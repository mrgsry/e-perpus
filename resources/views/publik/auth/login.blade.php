    ...
    <div class="card-body p-4">
      ...
      <form action="{{ route('mahasiswa.login.submit') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input id="nim" type="text" class="form-control" placeholder="Contoh: 20260001" name="nim" value="{{ old('nim') }}" required autofocus>
        ...
        <div class="input-group mb-3">
          <input id="token" type="text" class="form-control text-uppercase" placeholder="6 digit token" name="token" maxlength="6" required>
          <div class="input-group-append">
            <div class="input-group-text bg-white">
      ...
      <div class="help-box mt-4">
        ...
        Akun hanya dapat digunakan jika data mahasiswa sudah disetujui admin dan memiliki token referral aktif.
      </div>
