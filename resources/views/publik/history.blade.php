...
<div class="wrapper">
  <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom-0 shadow-sm">
    ...
    <ul class="navbar-nav ml-auto align-items-center">
      ...
      @else
        <li class="nav-item">
          <a href="{{ route('mahasiswa.login') }}" class="btn btn-sm text-white" style="background:linear-gradient(135deg,#1d4ed8,#1e3a8a);border:none;border-radius:10px;">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex align-items-center">
        <div class="image">
          <img src="{{ asset('adminlte/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="Mahasiswa">
        </div>
        <div class="info">
          @isset($mahasiswa)
            <a href="{{ route('mahasiswa.dashboard') }}" class="d-block font-weight-semibold">{{ $mahasiswa->nama }}</a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
          ...
          <li class="nav-item">
            <a href="{{ route('publik.pinjam.form') }}" class="nav-link">
              ...
              <div class="col-md-8">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      Pantau status transaksi, tanggal pinjam, dan pengembalian buku secara responsif.
                    </p>
                    <small class="text-white-50">Gunakan NIM dan token referral jika belum login ke dashboard mahasiswa.</small>
                  </div>
                </div>
              </div>
        ...
        @empty($mahasiswa)
          <div class="card panel-card lookup-card">
            <div class="card-header bg-white border-0 pt-4 px-4">
              ...
              <br>
              <small class="text-muted">Masukkan NIM dan token referral aktif untuk melihat data peminjaman.</small>
            </div>
            <form method="POST" action="{{ route('publik.history.show') }}">
              ...
              <div class="card-body p-4">
                <div class="row">
                  <div class="col-md-5 mb-3">
                    ...
                    <div class="input-group">
                      <input id="nim" type="text" name="nim" class="form-control" placeholder="Contoh: 20260001" required value="{{ old('nim') }}" autofocus>
                  ...
                  <div class="col-md-5 mb-3">
                    ...
                    <div class="input-group">
                      <input id="token" type="text" name="token" class="form-control text-uppercase" placeholder="6 digit token" required maxlength="6" value="{{ old('token') }}">
                      <div class="input-group-append">
                        <div class="input-group-text bg-white">
                ...
                <div class="alert mb-0" style="background:#f8fbff;border-left:4px solid #1d4ed8;color:#334155;border-radius:10px;">
              ...
              <div class="profile-tile">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <span class="badge mt-2" style="background:#dbeafe;color:#1e3a8a;border:1px solid #bfdbfe;">
            ...
            <div class="card-header bg-white border-0 pt-4 px-4">
              <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                ...
                <div class="mt-3 mt-md-0">
                  <a href="{{ route('publik.history.form') }}" class="btn btn-outline-secondary" style="border-radius:10px;">
                ...
                <tbody>
                  @forelse($peminjaman as $p)
                    <tr>
                      ...
                      <td>
                        <div class="font-weight-semibold">{{ $p->buku->judul ?? $p->buku->nama_buku ?? '-' }}</div>
                      ...
                      <td>
                        @php
                          ...
                          ][$p->status] ?? 'background:#f1f5f9;color:#475569;border:1px solid #e2e8f0;';
                        @endphp
                        <span class="badge badge-status" style="{{ $statusStyle }}">{{ ucfirst($p->status ?? '-') }}</span>
                      </td>
                      ...
                      <td>{{ ($p->tanggal_kembali_aktual ?? $p->tanggal_kembali) ? \Carbon\Carbon::parse($p->tanggal_kembali_aktual ?? $p->tanggal_kembali)->format('d/m/Y') : '-' }}</td>
                    </tr>
                  @empty
                    <tr>
                      <td colspan="6" class="empty-state">
                        ...
                        <small>Riwayat akan muncul setelah mahasiswa melakukan peminjaman buku.</small>
                      </td>
                    </tr>
                  @endforelse
                </tbody>
